...
uses
  ...
  Fmx.StdCtrls,
  FMX.Forms,
  FMX.Header, System.Rtti, FMX.Controls, FMX.Types, FMX.Layouts, FMX.Grid,
...
begin
  ...
  begin
    ...
    try
      ...
      {$IFNDEF D20}        //Replaced in D20, with [Options]
      StringGrid1.ShowHeader := true; // FixedRows := 1;
      {$ENDIF}
    finally
      StrList.Free;
    end;
...
begin
  ...
  if LastIndex <> -1 then Button1.Text := 'Next'
  else Button1.Text := 'Find';
end;
