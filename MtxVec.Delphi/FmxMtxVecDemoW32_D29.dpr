...
uses
  ...
  PlatformHelpers in 'PlatformHelpers.pas',
  ...
  ValueEditorFrame in 'ValueEditorFrame.pas' {frmValueEditor: TFrame},
  YuleLevinson in 'YuleLevinson.pas' {YuleLev},
  DewProbCalc in 'DewProbCalc.pas' {frmProbCalc},
  ExprToolTipUnit in 'ExprToolTipUnit.pas' {ExprToolTipForm},
  ScriptingGrid in 'ScriptingGrid.pas' {ScriptingGridForm},
  HintUnit in 'HintUnit.pas' {HintForm};
