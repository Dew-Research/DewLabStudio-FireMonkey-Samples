...
uses
  ...
  System.UITypes,
  System.Classes,
  Basic2, MtxExpr, Optimization,
  MtxIntDiff, MtxParseClass, MtxParseExpr,
  Math387,PlatformHelpers, System.Rtti,
...
begin
  ...
  {$IFDEF D20}
  StringGridVars.Options := StringGridVars.Options - [TGridOption.Header];
  StringGridResults.Options := StringGridResults.Options - [TGridOption.Header];
  {$ELSE}
  StringGridVars.ShowHeader := False;
  StringGridResults.ShowHeader := False;
  {$ENDIF}
...
begin
  ...
  try
    ...
    //required from XE6 onward
    StringGridVars.Repaint;
    StringGridResults.Repaint;
