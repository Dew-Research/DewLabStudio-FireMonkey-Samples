...
uses
  ...
  FMX.Forms,
  Fmx.StdCtrls,
  FMX.Header, SignalProcessing, SignalTools, FMXTee.Editor.EditorPanel,
  MtxDialogs, SignalToolsDialogs, MtxBaseComp, SignalAnalysis, SignalToolsTee,
  FMXTee.Engine, FMXTee.Series, FmxMtxVecTee, FMXTee.Procs, FMXTee.Chart,
  FmxMtxComCtrls, FMX.Layouts, FMX.Memo, FMX.Edit,
...
//     h := 1/Len;
     ...
     ResV := Ramp(Len,0,Freq/Len) + e;   //our resample vector. 
