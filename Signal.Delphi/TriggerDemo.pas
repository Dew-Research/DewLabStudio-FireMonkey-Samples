...
uses
  ...
  FMX.Platform,
  Fmx.StdCtrls,
  FMX.Header, SignalTools, AudioSignal, FMXTee.Editor.EditorPanel, MtxDialogs,
  SignalToolsDialogs, MtxBaseComp, SignalAnalysis, SignalToolsTee,
  FMXTee.Engine, FMXTee.Series, FMXTee.Procs, FMXTee.Chart, FmxMtxComCtrls,
  SignalUtils, FMX.ListBox, FMX.Controls.Presentation;
...
begin
    ...
    SignalIn1.TriggerAbove := AboveEdit.FloatPosition;
    ...
    begin
        ...
        CountLabel.Text := 'Count = ' + IntToStr(SignalIn1.TriggerCount[ChannelBox.ItemIndex]);
    end;
end;
