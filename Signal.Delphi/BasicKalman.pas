...
begin
   z := RandGauss(n_iter,mvDouble, x,NoiseSigma); //Keep signal noise the same, just recreate the series
   Compute;
end;
...
var  i: integer;
     ...
     R: TSample;
begin
    Q := qEdit.FloatPosition; //-5; // # process variance
...
//    # allocate space for arrays
    ...
    R := rEdit.FloatPosition; // # estimate of measurement variance, change to see effect
