...
uses
  ...
  Fmx.StdCtrls,
  FMX.Header,
  FmxMtxFastLineEdit, MtxDialogs, SignalToolsDialogs, FMXTee.Editor.EditorPanel,
  SignalTools, FileSignal, MtxBaseComp, SignalAnalysis, FMX.Layouts, FMX.Memo,
  FMX.Edit, FmxMtxComCtrls, FMXTee.Series, SignalToolsTee, FMXTee.Engine,
  FmxMtxVecTee, FMXTee.Procs, FMXTee.Chart, FMX.Controls.Presentation,
  FMX.ScrollBox;
...
uses SignalUtils, Math387, MtxExpr, MtxVec, AbstractMtxVec, Basic1;
