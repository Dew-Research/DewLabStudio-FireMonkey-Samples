...
uses
  ...
  SignalProcessing, SignalTools, FileSignal,
  ...
  FMXTee.Chart, FMX.Layouts, FMX.Memo, FMX.ScrollBox, FMX.Controls.Presentation;
...
procedure TEnvelopeDemoForm.SpectrumAnalyzerParameterUpdate(
  Sender: TObject);
begin
