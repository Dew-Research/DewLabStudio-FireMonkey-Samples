...
uses
  ...
  FMX.Memo,
  Fmx.StdCtrls,
  FMX.Header, FileSignal, SignalProcessing, SignalTools,
  FMXTee.Editor.EditorPanel, MtxDialogs, SignalToolsDialogs, MtxBaseComp,
  SignalAnalysis, FMX.Layouts, FMX.Edit, FmxMtxComCtrls, FMXTee.Engine,
  SignalToolsTee, FMXTee.Series, FMXTee.Procs, FMXTee.Chart,
...
uses Math387, SignalUtils, FmxMtxVecTee, Basic1;
...
begin
    ...
    SignalWrite1.FileName := GetFile1('bz.dat');
    ...
    SpectrumAnalyzer.Update;
    FilePositionEdit2.FloatPosition := Round(2*SignalDecimator1.FilterDelay*SignalDecimator1.Factor); //SpectrumAnalyzer1.Update;

    FilterDelayLabel.Text := 'Delay: ' + FormatSample('0.#',SignalDecimator1.FilterDelay*SignalDecimator1.Factor);
