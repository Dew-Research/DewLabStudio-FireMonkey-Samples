...
//    BorderStyle := TFMXFormBorderStyle.bsNone;
  ...
  try
      // Distance matrix
      aForm.MDScaling.Data.SetIt(6,6,false,
      [0,2,3,4,5,5,
       2,0,3,5,6,5,
       3,3,0,5,4,6,
       4,5,5,0,4,3,
      ...
      aForm.MDScaling.DataFormat := mdFormatDissimilarities;
      aForm.MDScaling.Dimensions := 2;
  except
  end;
  aForm.UpdateData;
//  aForm.
