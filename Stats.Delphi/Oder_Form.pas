...
begin
  ...
  begin
    ...
    Add('Your Stats Master license will be valid for minor and major version '+
        ...
        'on you will have the option to extend the subscription period. Tech support is fee free with 48h response.');
    Add(chr(10));
    Add('NOTE: Stats Master is build on top of the latest MtxVec package and therefore requres it.' +
        ...
        'please visit http://www.dewresearch.com/ where you will find all the '+
